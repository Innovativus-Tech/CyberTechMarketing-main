          ...
          <div className="about-page-copy" style={{ maxWidth: '900px', margin: '0 auto', textAlign: 'center' }}>
            <Reveal direction="up">
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', marginBottom: '24px', color: 'var(--red)', fontSize: '0.9rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.1em' }}>
                ...
                <span className="text-white">AI & Intelligent Solutions</span>
              </div>
              <h1 style={{ fontSize: 'clamp(2.8rem, 6vw, 4.5rem)', lineHeight: 1.1 }}>AI & Intelligent Solutions</h1>
              <p style={{ fontSize: '1.25rem', marginTop: '24px', color: 'rgba(255,255,255,0.85)', lineHeight: 1.6, maxWidth: '760px', marginInline: 'auto' }}>
                Automate workflows and unlock new capabilities with generative AI and LLMs.
              </p>
        ...
        <div className="site-container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '60px', alignItems: 'start' }}>
            ...
            <Reveal direction="up" style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
              ...
              <h2 style={{ fontSize: '2.5rem', fontWeight: 900, marginBottom: '24px', color: 'var(--ink)' }}>Driving results with AI & Intelligent Solutions</h2>
              <p style={{ fontSize: '1.15rem', color: 'var(--muted)', lineHeight: 1.7 }}>
                We integrate practical Artificial Intelligence into your business operations. Whether it's deploying intelligent customer service bots, automating content generation, or building internal AI assistants, we help you work smarter.
              </p>
            </Reveal>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '24px', marginTop: '40px' }}>
              ...
              <Reveal direction="up" delay={0}>
                <div style={{ background: 'white', border: '1px solid #e1e5ea', borderRadius: '16px', padding: '32px', height: '100%', transition: 'transform 0.3s ease', cursor: 'default' }} className="hover:-translate-y-2 hover:shadow-xl">
                  ...
                  <h3 style={{ fontSize: '1.25rem', fontWeight: 800, color: 'var(--ink)', marginBottom: '12px' }}>Custom AI Assistants</h3>
                  <p style={{ color: 'var(--muted)', lineHeight: 1.6 }}>LLM-powered chatbots trained on your internal knowledge bases to assist staff and customers.</p>
                </div>
              </Reveal>
              ...
              <Reveal direction="up" delay={0.1}>
                <div style={{ background: 'white', border: '1px solid #e1e5ea', borderRadius: '16px', padding: '32px', height: '100%', transition: 'transform 0.3s ease', cursor: 'default' }} className="hover:-translate-y-2 hover:shadow-xl">
                  ...
                  <h3 style={{ fontSize: '1.25rem', fontWeight: 800, color: 'var(--ink)', marginBottom: '12px' }}>Workflow Automation</h3>
                  <p style={{ color: 'var(--muted)', lineHeight: 1.6 }}>Replacing manual data entry and repetitive tasks with intelligent, error-free AI pipelines.</p>
                </div>
              </Reveal>
              ...
              <Reveal direction="up" delay={0.2}>
                <div style={{ background: 'white', border: '1px solid #e1e5ea', borderRadius: '16px', padding: '32px', height: '100%', transition: 'transform 0.3s ease', cursor: 'default' }} className="hover:-translate-y-2 hover:shadow-xl">
                  ...
                  <h3 style={{ fontSize: '1.25rem', fontWeight: 800, color: 'var(--ink)', marginBottom: '12px' }}>Generative Design & Copy</h3>
                  <p style={{ color: 'var(--muted)', lineHeight: 1.6 }}>Dynamic systems that automatically generate personalized marketing copy and assets at scale.</p>
                </div>
              </Reveal>
              ...
              <Reveal direction="up" delay={0.30000000000000004}>
                <div style={{ background: 'white', border: '1px solid #e1e5ea', borderRadius: '16px', padding: '32px', height: '100%', transition: 'transform 0.3s ease', cursor: 'default' }} className="hover:-translate-y-2 hover:shadow-xl">
                  ...
                  <h3 style={{ fontSize: '1.25rem', fontWeight: 800, color: 'var(--ink)', marginBottom: '12px' }}>Computer Vision & OCR</h3>
                  <p style={{ color: 'var(--muted)', lineHeight: 1.6 }}>Extracting data from physical documents and analyzing images using advanced neural networks.</p>
                </div>
              </Reveal>
        ...
        <div className="site-container">
          <Reveal direction="scale">
            ...
            <p style={{ fontSize: '1.2rem', color: 'rgba(255,255,255,0.7)', marginBottom: '40px', maxWidth: '600px', margin: '0 auto 40px' }}>
              Partner with Cybertech Marketing to leverage cutting-edge ai & intelligent solutions tailored to your unique goals.
            </p>
