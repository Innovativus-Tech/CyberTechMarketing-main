    ...
    <main className="w-full">
      ...
      <section className="relative w-full h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
          ...
          <p className="text-xl text-red-100 max-w-2xl mx-auto">
            Custom, responsive, and high-performance websites tailored to your brand and business goals.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-4xl font-bold text-slate-900 mb-6">Why Web Development?</h2>
            <p className="text-lg text-slate-600 mb-6">
              Our Web Development services are designed to give you a competitive edge in today's fast-paced digital landscape. We focus on delivering high-quality, scalable solutions tailored to your unique requirements.
            </p>
