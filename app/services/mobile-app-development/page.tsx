    ...
    <main className="w-full">
      ...
      <section className="relative w-full h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
          ...
          <p className="text-xl text-red-100 max-w-2xl mx-auto">
            Engaging and intuitive mobile applications for iOS and Android platforms.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-4xl font-bold text-slate-900 mb-6">Why Mobile App Development?</h2>
            <p className="text-lg text-slate-600 mb-6">
              Our Mobile App Development services are designed to give you a competitive edge in today's fast-paced digital landscape. We focus on delivering high-quality, scalable solutions tailored to your unique requirements.
            </p>
          ...
          <div className="relative h-[400px]">
            <Image 
              src="https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?q=80&w=2070&auto=format&fit=crop"
              alt="Mobile App Development Analytics"
              fill
