...
export default function WhyChooseUs({
  ...
  return (
    <section id="about" className="py-32 relative bg-[#FAFAFA]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div key={highlight.title + index} className="flex items-center gap-4 p-4 rounded-xl bg-[#FAFAFA] border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {reasons.map((reason, idx) => (
              <div key={idx} className="p-6 rounded-xl bg-[#FAFAFA] border border-gray-200 hover:border-red-300 hover:shadow-lg transition-all">
