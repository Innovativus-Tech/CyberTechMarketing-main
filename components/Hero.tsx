  ...
  return <section className="cm-hero" id="home">
    <div className="site-container cm-hero-grid">
      <Reveal className="cm-hero-copy" direction="left">
        ...
        <div className="cm-hero-actions"><Link className="button button-primary" href="#enquiry">BOOK A GROWTH CALL <ArrowUpRight size={18} /></Link><a className="button button-ghost" href="https://wa.me/917428768779" target="_blank" rel="noreferrer"><Phone size={18} /> WHATSAPP US</a></div>
      </Reveal>
